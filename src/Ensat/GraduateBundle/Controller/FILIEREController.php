...
use Ensat\GraduateBundle\Form\FILIEREType;
...
class FILIEREController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('EnsatGraduateBundle:FILIERE')->findAll();
     ...
     *
     * @Route("/", name="filiere_create")
     * @Method("POST")
     * @Template("EnsatGraduateBundle:FILIERE:new.html.twig")
     */
    ...
    */
     ...
     *
     * @Route("/{id}", name="filiere_update")
     * @Method("PUT")
     * @Template("EnsatGraduateBundle:FILIERE:edit.html.twig")
     */
