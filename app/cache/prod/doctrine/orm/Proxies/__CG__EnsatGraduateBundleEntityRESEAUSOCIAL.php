 ...
 */
class RESEAUSOCIAL extends \Ensat\GraduateBundle\Entity\RESEAUSOCIAL implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'designation', 'identifiant');
    }
