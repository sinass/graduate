 ...
 */
class FILIERE extends \Ensat\GraduateBundle\Entity\FILIERE implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'designation', 'promotion', 'laureats');
    }
